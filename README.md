...
| :------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------- |
| 🌐 [Tech Mídia](https://tech-midia.com)                                                            | Plataforma digital voltada a tecnologia, mídia e soluções online.                                                            | Web Development, UI/UX, Digital Solutions  |
| 👨‍💻 [Cassius Barg](https://cassiusbarg.com)                                                        | Portfólio profissional com apresentação de projetos, experiência, competências técnicas e serviços de desenvolvimento.       | Web Development, Software Engineering      |
| 👓 [Ótica Personalidade](https://oticapersonalidade.com.br)                                        | Site institucional e catálogo digital para ótica, com foco em produtos, serviços, presença digital e conversão de clientes.  | Web Development, UX/UI, Digital Marketing  |
